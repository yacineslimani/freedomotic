...
public class JenaEngine {
	...
	/***
	 * 
	 * Mettre a jour la valeur d'u ne propriete objet d'u ne instance*
	 * 
	 * @param args
	 *            + Entree: - l'objet model Jena*- Namespace de l'ontologie*- Le
	 ...
	 * 
	 * @param args
	 *            + Entree: - l'objet model Jena - Namespace de l'ontologie9 -
	 *            Le nom de l'Instance - Le nom de la propriete - La valeur +
